...
const ToDoList = () => {
  ...
  const handleClose = async () => {
    ...
    await axios
      .post(
        "https://28ivb3d4wd.execute-api.eu-west-1.amazonaws.com/test/get-tasks-by-username",
        { username }
      )
      .then((res) => {
  ...
  const deleteTask = async (id) => {
    try {
      await axios.delete(
        `https://28ivb3d4wd.execute-api.eu-west-1.amazonaws.com/test/delete-task/${id}`
      );
